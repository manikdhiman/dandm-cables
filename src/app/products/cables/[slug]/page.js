    ...
    return (
      <main className="min-h-screen bg-brand-ice/20 py-24 px-6 text-center">
        <div className="max-w-md mx-auto bg-white p-8 rounded-3xl border border-gray-100 shadow-xl space-y-4">
          ...
          <p className="text-xs text-brand-gray">The requested cable specification does not exist.</p>
          <Link href="/products/cables" className="inline-block bg-brand-teal text-white text-xs font-bold px-6 py-3 rounded-xl">
            Back to Power Cables
          </Link>
        </div>
      </main>
    );
    ...
    <main className="min-h-screen bg-brand-ice/20 pb-24 pt-28">
      <div className="max-w-6xl mx-auto px-6 space-y-12">
        ...
        <div className="flex items-center gap-2 text-xs font-medium text-brand-gray">
          ...
          <Link href="/products/cables" className="hover:text-brand-teal transition">Power Cables</Link>
          <ChevronRight size={12} />
              ...
              <>
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea rows="3" placeholder="Specify cable core requirements, voltage ratings, or drum lengths..." className="w-full p-3 rounded-xl border border-gray-200 focus:outline-none focus:border-brand-teal" />
                  </div>
